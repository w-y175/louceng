...
<div class="con">
    <div class="left">
        ...
        <h5>指导价{{datalist.market_attribute&&datalist.market_attribute.official_refer_price}}</h5>
    </div>
    <div class="right">
        <button @click="skip">{{datalist.BottomEntranceTitle}}</button>
    </div>
</div>
<div class="count">
<div class="top" >
   <span v-for="(item,index) in list " :key="index" :class="{active:cur==index}" @click="tab(index)">{{item}}</span>
</div>

<div class="list" v-for="(item,index) in datalist.list" :key='index'>
...
<div class="buttom">
    <p @click="skip">{{datalist.BottomEntranceTitle}}</p>
